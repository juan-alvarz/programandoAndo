...
const Puntuation = () => {
  ...
  return (
    <div
      ...
      className="shadow-lg py-5 overflow-hidden hover:overflow-y-scroll scrolling-touch"
    >
      <div>
        <div
          style={{
        ...
        <div
          ...
          className="px-10 my-5 text-center"
        >
          {user.pageOpinion ? (
            <p>Tu opinion: {user.pageOpinion}</p>
          ) : (
            <p>
              Your opinion is very important to us, we invite you to leave us
              your comment and give us a rating.
            </p>
          )}
        </div>
