...
const Footer = () => {
  return (
    <footer className="p-4 bg-gray-900 border border-solid border-gray-800 sm:p-6 dark:bg-gray-900">
        <div className="md:flex md:justify-evenly">
            <div className="flex justify-center mb-6 md:mb-6">
                <a className="flex items-center">
                    <img src={img} className="mr-3 h-8" />
                    <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">SoyLucho</span>
                </a>
            </div>
            <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-2 justify-items-center">
                <div>
                    <h2 className="mb-6 text-xs font-semibold text-yellow-300 uppercase dark:text-white">Schools</h2>
                    <ul className="text-xs text-gray-400 dark:text-gray-400">
                        <li className="mb-2">
                ...
                <div>
                    <h2 className="mb-6 text-xs font-semibold text-yellow-300 uppercase dark:text-white">Follow us</h2>
                    <ul className="text-xs text-gray-400 dark:text-gray-400">
                        <li className="mb-2">
        ...
        <div className="sm:flex sm:justify-items-center">
            <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="https://flowbite.com/" className="hover:underline">SoyLucho</a>. All Rights Reserved.
            </span>
