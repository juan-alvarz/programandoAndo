              ...
              <div>
                ...
                >
                  ...
                  <div
                    ...
                    className="flex w-24 h-16 mr-20"
                  >
                    <button
                      style={{
                        backgroundColor: "rgb(17, 52, 82)",
                      ...
                      className="my-4 p-2 rounded-md w-24 flex justify-center items-center"
                      type="submit"
                    >
                      Send
                    </button>
                    <button
                      ...
                      className="my-4 p-2 rounded-md ml-6 w-24 flex justify-center items-center"
