...
export const CourseMoreDetail = ({element}) => {
  ...
  return (
    <div>
       <button onClick={handleMostrar} className="py-2.5 px-5 mr-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-#A84C65 hover:text-blue-800 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">More details</button>
    <div className=' p-10 bg-white backdrop-opacity-60  rounded-lg border border-gray-200 shadow-md hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700' style={{display:hidden,position:position2,boxShadow: '2px 2px 9px #312928',width:"50%"}}>
