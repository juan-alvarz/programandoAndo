    ...
    return usuario ? (
      ...
      <NavBar />
        <div style={{display: 'flex'}}>
          ...
          <div>
          <div style={{height: 600}} className='flex justify-center overflow-hidden hover:overflow-y-scroll scrolling-touch'>
              ...
              foro.comments.map(            
                ...
                <ol style={{borderWidth: 1, height: 320}} className='rounded-md my-5 border-gray-300 overflow-hidden hover:overflow-y-scroll scrolling-touch'>
                  ...
                  <h3>{comment.answers?.map(
                    ...
                    <p className="text-sm font-bold">{answer.authorComment? answer.authorComment.name: "no se encuenta master"}</p>
