          ...
          <>
            ...
            <Disclosure.Panel className="md:hidden">
              <div className="space-y-1 px-2 pt-2">
                <Menu as="div" className="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md">
                          <div>
                            <Menu.Button className="text-gray-300 hover:bg-gray-700 hover:text-white">
                              <h3 className="text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium">Schools</h3>
                            </Menu.Button>
                          </div>
                          <Transition
                            as={Fragment}
