  ...
  if (!user) {
    ...
    return (
      <div className="w-full h-full" style={{backgroundColor: 'rgb(240, 240, 240)'}}>
        ...
        <NavBar/>
          <div style={{backgroundColor: 'rgb(240, 240, 240)'}} className="sm:flex justify-center content-center md:mx-24 lg:my-10 py-10 xl:mx-96 rounded-lg">
            <div className="grid grid-cols-1 md:flex my-10 items-center">
              <form
                ...
                style={{ margin: "auto", backgroundColor: 'rgb(240, 240, 240)' }}
              >
                <h2 style={{color: 'rgb(17, 52, 82)'}} className="text-gray-700 font-bold text-center text-xl">
                  Donation
                </h2>
                <label style={{color: 'rgb(17, 52, 82)'}} className="text-gray-700 text-center font-bold py-4">
                  Amount
                </label>
                <input
                ...
                <button
                  ...
                  style={{ margin: "auto", backgroundColor: 'rgb(55, 109, 109)' }}
                >
                  Donate
                </button>
              </form>
              <div className="mx-8 mt-10 md:mt-0">
                <div style={{color: 'rgb(55, 109, 109)'}} className="text-sm text-center md:text-md md:text-left md:text lg:text-xl font-bold leading-tight my-2 uppercase">
                  With this donation you are helping us to maintain the platform and keep growing to provide the best content possible
                </div>
                <div style={{color: 'rgb(168, 76, 101)'}} className="text-xs text-center md:text-left md:text-md mt-3 sm:text-md font-bold uppercase">
                  {`The community has donated ${totalAmount} usd so far. Thank you all for continuing to help make this possible!`}              
                </div>
                <div className="flex justify-center md:justify-start">
                  <img src="https://assets.stickpng.com/images/580b57fcd9996e24bc43c530.png" alt="image paypal" className="w-24 mt-5"/>
                </div>
              </div>
            </div>
          </div>
