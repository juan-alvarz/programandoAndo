...
let usuariosPrueba = [
    ...
    },
    {
        ...
        "banned": false,
        "status": "pending",
        "confirmationCode": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6ImRhbmllc3BhcnRhbjExNkBnbWFpbC5jb20iLCJpYXQiOjE2NjI3NDQ4OTR9.sPmjkPUVVqW4DOcF217G_N6H-ql56y7sGmIrMGua1qg",
        "deleted": false,
    ...
    },
    {
        ...
        "banned": false,
        "status": "active",
        "confirmationCode": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6Imx1aXN3YmxhbmNvQGdtYWlsLmNvbSIsImlhdCI6MTY2Mjc3MjEwNn0.WWtcYLsheI6EU9BsKaPGFCqBWi-99JTaPIcy3y3FJRs",
        "deleted": false,
    ...
    },
    {
        ...
        "banned": false,
        "status": "active",
        "confirmationCode": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6Imx1Y2hvYXBpZnJlZUBnbWFpbC5jb20iLCJpYXQiOjE2NjI3NzI5NzB9.o1kIQw_7pJPDZ-3-4uKrf8o_UJG4ainPgSlNi2KE8eI",
        "deleted": false,
    ...
    },
    {
        ...
        "banned": false,
        "status": "active",
        "confirmationCode": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6ImphMDAzMTQ3MUBnbWFpbC5jb20iLCJpYXQiOjE2NjI4MTk2NzR9.uiHThLsVIRNes4hkU3js4m7JGZeTYHQzLCyn0FyTT9k",
        "deleted": false,
    ...
    },
    {
        ...
        "banned": false,
        "status": "active",
        "confirmationCode": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6ImRhbnpzdjk0QG91dGxvb2suZXMiLCJpYXQiOjE2NjI5NDAyNzB9.CpYQzjSdzFPYkkf6iWq3OLr5sIDHGxR6gfL3_jY5VhE",
        "deleted": false,
    ...
    },
    {
        ...
        "banned": false,
        "status": "active",
        "confirmationCode": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6ImRhbnpzdjk0QGdtYWlsLmNvbSIsImlhdCI6MTY2MzAwNTQ5Mn0.8lTVpw1BPQohTLTH1Z_pz4Caze_dEGZpzQn5yJdwRWY",
        "deleted": false,
    ...
    },
    {
        ...
        "banned": false,
        "status": "active",
        "confirmationCode": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6InRlYW0uZHN4aWVAZ21haWwuY29tIiwiaWF0IjoxNjYzMDk1MjM2fQ.9xBQ8MBKvXtwaI3H6dpCI5MiYnX-xgeNrL6wcWzG_aA",
        "deleted": false,
...
const RankUserDonation = () => {
    ...
    return (
        <div>
            ...
            <div>
                {usersActuales ? usersActuales.map((elemento, index) => {
                    return (
                        <div key={index} className="m-3 p-3 rounded-md shadow-lg" style={{ backgroundColor: "rgb(17, 52, 82)", marginLeft: "20%", marginRight: "20%" }} >
                            <ul className="max-w-md divide-y divide-gray-200 dark:divide-gray-700" >
                                <li className="pb-3 sm:pb-4">
                                    <div className="flex items-center space-x-4">

                                        <div className="flex-1 min-w-0">
                                            <p className="text-sm font-medium text-gray-900 truncate " style={{ color: "rgb(201, 196, 184)", fontSize: 19 }}>
                                                {
                                                    elemento.name
                                                }
                                            </p>
                                            <p className="text-sm text-gray-500 truncate dark:text-gray-400" style={{ color: "rgb(201, 196, 184)" }}>
                                                {elemento.username}
                                            </p>
                                        </div>
                                    ...
                                    <div>
                                        <img src={index === 0 ? oro : ""}></img>
                                        <img src={index === 1 ? plata : ""}></img>
                                        <img src={index === 2 ? bronce : ""}></img>
