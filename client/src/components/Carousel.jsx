                            ...
                            <Slider>
                                <div>
                                    {carouselCourses.map(e => {
                                        ...
                                        return(
                                        <Slide key={e._id}>
                                            <div style={{maxWidth: 450, height: 580, backgroundColor: 'rgb(17, 52, 82)', marginTop: 5, marginLeft: 10, marginRight: 10, borderRadius: 10}}>
                                                <img style={{minHeight: 180, maxHeight: 180, width: '100%', objectFit: "cover", borderTopLeftRadius: 10, borderTopRightRadius: 10}} src={e.image} alt='img not found'/>
                                                <div style={{marginTop: 20, marginLeft: 10, marginRight: 5}}>
                                                    <h2 style={{fontSize: 20, display: 'flex', color: 'rgb(201, 196, 184)', justifyContent: "center"}}>{e.name}</h2>
                                                    <div style={{marginTop: 40}}>
                                                        <h3 style={{fontSize: 15, display: 'flex', color: 'rgb(201, 196, 184)', justifyContent: "center", minHeight: 250}}>{e.description}</h3>
                                                    </div>
                                                    <NavLink to={`/course/${e._id}`}>
                                                        <div style={{display: "flex", justifyContent: "center", alignContent: "center"}}>
                                                            <button style={{backgroundColor: 'rgb(55, 109, 109)', color: 'rgb(201, 196, 184)'}} className="py-2.5 px-5 mr-2 mb-2 text-sm font-semi-bold focus:outline-none bg-blue-700 rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
                                                                Read more
                                                            </button>
                                                        </div>
                                                    </NavLink>
                            ...
                            <Slider>
                                <div>
                                    {carouselCourses.map(e => {
                                        ...
                                        return(
                                        <Slide key={e._id}>
                                            <div style={{maxWidth: 450, height: 580, backgroundColor: 'rgb(17, 52, 82)', marginTop: 5, marginLeft: 20, borderRadius: 10}}>
                                                <img style={{minHeight: 180, maxHeight: 180, width: '100%', objectFit: "cover", borderTopLeftRadius: 10, borderTopRightRadius: 10}} src={e.image} alt='img not found'/>
                                                <div style={{marginTop: 20, marginLeft: 10, marginRight: 5}}>
                                                    <h2 style={{display: 'flex', color: 'rgb(201, 196, 184)', justifyContent: "center"}}>{e.name}</h2>
                                                    <div style={{marginTop: 40}}>
                                                        <h3 style={{display: 'flex', color: 'rgb(201, 196, 184)', justifyContent: "center", minHeight: 250}}>{e.description}</h3>
                                                    </div>
                                                    <NavLink to={`/course/${e._id}`}>
                                                        <div style={{display: "flex", justifyContent: "center", alignContent: "center"}}>
                                                            <button style={{backgroundColor: 'rgb(201, 196, 184)', color: 'rgb(17, 52, 82)'}} className="py-2.5 px-5 mr-2 mb-2 text-sm font-semi-bold focus:outline-none bg-blue-700 rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
                                                                Read more
                                                            </button>
                                                        </div>
                                                    </NavLink>
                            ...
                            <Slider>
                                <div>
                                    {carouselCourses.map(e => {
                                        ...
                                        return(
                                        <Slide key={e._id}>
                                            <div style={{minWidth: 300, maxWidth: 450, height: 580, backgroundColor: 'rgb(17, 52, 82)', borderRadius: 10}}>
                                                <img style={{minHeight: 180, maxHeight: 180, width: '100%', objectFit: "cover", borderTopLeftRadius: 10, borderTopRightRadius: 10}} src={e.image} alt='img not found'/>
                                                <div style={{marginTop: 20, marginLeft: 10, marginRight: 5}}>
                                                    <h2 style={{display: 'flex', color: 'rgb(201, 196, 184)', justifyContent: "center"}}>{e.name}</h2>
                                                    <div style={{marginTop: 40}}>
